...
const EntryFlatList: React.FC<Props> = ({ entries }) => {
    ...
    return (
        <FlatList
            style={{ width: '100%', padding: 3, backgroundColor: 'pink' }}
            data={entries}
            renderItem={({ item }) => (
            ...
            ListHeaderComponent={
                () => (
                    <View style={[styles.inputContainerStyle, { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: "purple" }]}>
